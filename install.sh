...
# Configuration
CHART_PATH="./chart"
CHART_REPO="oci://ghcr.io/nimblebrain/charts"
...
REMOTE INSTALLATION:
    # Install directly from GitHub (uses published Helm chart)
    curl -sSL https://raw.githubusercontent.com/nimblebrain/nimbletools-core/main/install.sh | bash

For more information, visit: https://github.com/nimblebrain/nimbletools-core
EOF
}
...
show_post_install_info() {
    ...
    log_info "   https://github.com/nimblebrain/nimbletools-core"
    log_info ""
}
