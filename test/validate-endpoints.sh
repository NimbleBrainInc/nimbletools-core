...
echo "   127.0.0.1 api.nimbletools.local"
echo "   127.0.0.1 mcp.nimbletools.local"
echo ""
...
echo "   curl http://api.nimbletools.local/health"
echo "   curl http://mcp.nimbletools.local/health"